            ...
            >
                ...
                >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            <label className="mb-1.5 block text-xs font-semibold uppercase text-zinc-500 dark:text-zinc-400">Activo</label>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className="mb-1.5 block text-xs font-semibold uppercase text-zinc-500 dark:text-zinc-400">Cantidad</label>
                                <input
                                    type="number"
                                    value={quantity}
                            ...
                            <div>
                                <label className="mb-1.5 block text-xs font-semibold uppercase text-zinc-500 dark:text-zinc-400">Precio</label>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className="mb-1.5 block text-xs font-semibold uppercase text-zinc-500 dark:text-zinc-400">Comisión</label>
                                <div className="relative">
                                    <span className="absolute left-3 top-2.5 text-zinc-400">$</span>
                                    <input
                                        type="number"
                            ...
                            <div>
                                <label className="mb-1.5 block text-xs font-semibold uppercase text-zinc-500 dark:text-zinc-400">Fecha</label>
                                <input
                                    type="date"
                                    value={date}
