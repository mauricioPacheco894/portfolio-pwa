...
export default function HoldingsTable({ holdings }: HoldingsTableProps) {
  ...
  const currencyFormatterWithSign = new Intl.NumberFormat('en-US', {
    style: 'currency',
    currency: 'USD',
    signDisplay: 'always',
  });
            ...
            {sortedHoldings.length === 0 ? (
              ...
              sortedHoldings.map((asset) => (
                ...
                >
                  ...
                  <td className="px-4 py-2 text-right text-zinc-600 dark:text-zinc-400">
                    {currencyFormatter.format(asset.averageCost)}
                  </td>
                  <td className="px-4 py-2 text-right text-zinc-600 dark:text-zinc-400">
                    <div className="flex items-center justify-end gap-1">
                      {asset.marketPrice
                        ? currencyFormatter.format(asset.marketPrice)
                  ...
                  <td className="px-4 py-2 text-right">
                    ...
                    >
                      ...
                      <span className="text-xs opacity-80 font-normal">
                        ({currencyFormatterWithSign.format(asset.plDollars)})
                      </span>
                    </div>
                  </td>
                </tr>
